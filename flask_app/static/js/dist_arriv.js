function dist_arriv(data){
    ...
    var svg4 = d3.select("#inter_arriv")
        .append("svg")
    ...
    function plotdist(data) {
        ...
        var x = d3.scaleLinear()
            .domain([0,d3.extent(data)[1]]).nice()
        ...
        density = kde(epanechnikov(0.001), thresholds, data)
        ...
        var xAxis = d3.scaleLinear()
            .domain([0, d3.extent(data)[1]*1000]).nice()
            .range([margin.left, width - margin.right])
